...
/* Globals */
#define UPDATE_URL	"http://godtony.mooo.com/smac/smac_esea_banlist.txt"
...
public OnClientAuthorized(client, const String:auth[])
{
	...
	if (GetTrieValue(g_hBanlist, sAuthID, bShouldLog) && SMAC_CheatDetected(client) == Plugin_Continue)
	{
		if (bShouldLog)
		{
